...
query = "SELECT C.CropId, CC.Name, C.Images, C.CropName, C.Description FROM crops C JOIN cropcategory CC ON C.CCId = CC.CCId"
...
for x in myresult:
    tr_html += f'''
    <tr>
        <td><a href="CropsDelete.py?cid={x[0]}"><i class="fa-solid fa-trash"></i></a>
        <a href="CropsEdit.py?cid={x[0]}"><i class="fa-solid fa-pen-to-square"></i></a></td>
        <td>{x[0]}</td>
        <td>{x[1]}</td>
        <td><img src="assets/Crop/{x[0]}/{x[2]}" style="width: 100px; height: 100px;"></td>
        <td>{x[3]}</td>
        <td>{x[4]}</td>
    </tr>
    '''
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Crop List</h4>
                    </div>   
                </div>
            </div>
