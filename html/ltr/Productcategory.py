                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="ProductCategoryBackEnd.py" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="ProCatName">Product Category Name</label>
                                        <input type="text" class="form-control" id="ProCatName" name="ProCatName" aria-describedby="emailHelp" required>
                                    </div> 
                                    <div class="form-group">
                                        <label for="ProCatImg">Product Category Image</label>
                                        <input type="file" class="form-control" id="ProCatImg" name="ProCatImg" required>
                                    </div>   
                                    <div class="form-group">
