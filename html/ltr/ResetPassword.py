...
if(myresult):
    ...
    print(f"""      
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form class="form-horizontal m-t-20" id="loginform" action="UpdatePwd.py" method="POST">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter New Password" aria-label="Password" name="Password" id="Password" aria-describedby="basic-addon1">
                                    </div>
