...
for pro in product:
    pro_op += f'''
    <option value="{pro[0]}">{pro[3]}</option>
    '''
            ...
            <div class="email-app">
                ...
                <div class="mail-details bg-white">
                    ...
                    <div class="card-body border-bottom">
                        ...
                        <h4 class="m-b-15">Crop Name: <span style="color:gray"> {myresult[6]} </span></h4>
                        <h4 class="m-b-15">Crop Part: <span style="color:gray"> {myresult[7]} </span></h4>
                        <hr>
                        <h3> Query </h3>
                        <p>{myresult[8]}</p>
                    </div>
                ...
                <div class="mail-compose bg-white">
                    ...
                    <!-- Button group part -->
                    <div class="card-body">
                        <form action="queryBackEnd.py" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text" id="QId" name="QId" hidden value="{FQId}">
                                <input type="text" id="Email" name="Email" hidden value="{myresult[4]}">
                                <input type="text" id="que" name="que" class="form-control" placeholder="Subject" required>
                            </div>
                            <div class="form-group">
                                <textarea name="ans" id="ans" style="border: 2px solid #e1e1e1; background: #fafafa; color: #555555; padding: 20px; width: 100%; height: 165px; border-radius: 5px;" placeholder="Describe the Solution" required></textarea>
                            </div>
                            ...
                            <button type="submit" class="btn btn-success m-t-20" formaction="queryBackEnd.py"><i class="far fa-envelope"></i> Send Privatly</button>                            
                            <button type="submit" class="btn btn-dark m-t-20" formaction="publicBackEnd.py">Send Publicly</button>
                        </form>
                        <!-- Action part -->
                    </div>
                </div>
