...
query = f""" SELECT * FROM symptoms WHERE SId = {Id}"""
...
dse_op= ""
for dse in diseases:
    selected = "selected" if str(dse[0]) == str(myresult[1]) else ""
    dse_op += f'''
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="SymptomsUpdate.py" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="assets/Symptoms/{myresult[0]}/{myresult[2]}" style="width: 100px; height: 100px;"> &nbsp;&nbsp;&nbsp;
