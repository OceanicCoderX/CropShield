...
query = f"""UPDATE parts SET CrpId='{CrpId}', Name='{Name}', Image='{ImgName}' WHERE PartId ={Id}"""
# print(query)
mycursor.execute(query)
mydb.commit()
print(f'''
    <script>alert(" Crop Parts Update Successfully!");
