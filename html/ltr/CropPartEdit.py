...
query = f""" SELECT * FROM parts WHERE PartId  = {Id}"""
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="CropPartUpdate.py" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="CropPartName" name="CropPartName" aria-describedby="emailHelp" value="{myresult[2]}">
                                    </div>
                                    <div class="form-group">
                                        <label for="Image">Crop Category Image</label><br>
                                        <img src="assets/Part/{myresult[0]}/{myresult[3]}" style="width: 100px; height: 100px;"> &nbsp;&nbsp;&nbsp;
                                        <input type="file" id="Image" name="Image">
                                        <input type="hidden" id="OldImage" name="OldImage" value="{myresult[3]}">
                                    </div>                                                        
