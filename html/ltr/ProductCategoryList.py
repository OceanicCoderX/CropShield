...
for x in myresult:
    tr_html += f'''
    <tr>
        <td><a href="ProductCategoryDelete.py?cid={x[0]}"><i class="fa-solid fa-trash"></i></a>
        <a href="ProductCategoryEdit.py?cid={x[0]}"><i class="fa-solid fa-pen-to-square"></i></a></td>
        <td>{x[0]}</td>
        <td>{x[1]}</td>
        <td><img src="assets/ProductCategory/{x[0]}/{x[2]}" style="width: 100px; height: 100px;"></td>
        <td>{x[3]}</td>
    </tr>
    '''
