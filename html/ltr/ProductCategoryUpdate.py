...
# print(Id, Name, OldImage, Description)
...
if "Image" in form and form["Image"].filename:
    ...
    upload_dir = f"assets/ProductCategory/{Id}"
...
query = f"""UPDATE productcategory SET Name='{Name}', Image='{ImgName}',  Description='{Description}' WHERE PCId={Id}"""
# print(query)
mycursor.execute(query)
mydb.commit()
print(f'''
    <script>alert(" Product Category Update Successfully!");
